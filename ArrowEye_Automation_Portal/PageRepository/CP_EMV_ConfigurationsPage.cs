...
using ArrowEye_Automation_Portal.Tests.Feature;
...
namespace ArrowEye_Automation_Portal.PageRepository
{
    public class CP_EMV_ConfigurationsPage : TestBase
    {
        ...
        //check default value of Is In Test checkbox
        ...
        public void EditConfigurationss(string name, string issuer, string cardProfile, string personalizationScript, string module, string authentication, bool isInTest)
        {
            ValidatePageTitle();
        ...
        public void CloneConfigurationss(string name, string issuer, string cardProfile, string personalizationScript, string module, string authentication, bool isInTest, string newIssuer, string newCardProfile)
        {
            ...
            //validate newly cloned record in EMV Issuer homepage
